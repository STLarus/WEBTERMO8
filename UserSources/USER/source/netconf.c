...
void LwIP_Init(void)
    ...
    if(!GetResetJumperState())
        ...
        {
        adr32=EEread_32(EE_IP);
        IP4_ADDR(&ipaddr,(uint8_t)(adr32>>24), (uint8_t)(adr32>>16), (uint8_t)(adr32>>8), (uint8_t)(adr32));
        adr32=EEread_32(EE_SUBNET);
        IP4_ADDR(&netmask, (uint8_t)(adr32>>24), (uint8_t)(adr32>>16), (uint8_t)(adr32>>8), (uint8_t)(adr32));
        adr32=EEread_32(EE_GATEWAY);
        IP4_ADDR(&gw,(uint8_t)(adr32>>24), (uint8_t)(adr32>>16), (uint8_t)(adr32>>8), (uint8_t)(adr32));
        }
#endif
